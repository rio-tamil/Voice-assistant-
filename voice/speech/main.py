...
if __name__=='__main__':
    ...
    while True:
        ...
        if 'wikipedia' in statement:
            ...
            speak('I am in a relationship with RO')
        ...
        elif "youtube" in statement.lower():
            ind = statement.lower().split().index("youtube")
        ...
        elif "search" in statement.lower():
            ind = statement.lower().split().index("search")
            search = statement.split()[ind + 1:]
            webbrowser.open(
                "https://www.google.com/search?q=" + "+".join(search))
            speak = speak + "Searching " + str(search) + " on google"

        elif "google" in statement.lower():
            ind = statement.lower().split().index("google")
            search = statement.split()[ind + 1:]
            webbrowser.open(
                "https://www.google.com/search?q=" + "+".join(search))
            speak = speak + "Searching " + str(search) + " on google"

        elif "where is" in statement.lower():
            api_key = "https://www.google.co.in/maps/@10.7828364,78.2885026,7z"
            ...
            # Construct the URL
            url = endpoint + "query=" + query + "&key=" + api_key
            ...
            speak("I was built by tamil")
            print("I was built by tamil")
